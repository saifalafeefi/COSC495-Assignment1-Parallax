...
{
    /// <summary>
    /// floating score number with green color and positive feedback (e.g., +25).
    /// </summary>
    public class ScoreNumber : MonoBehaviour
    {
        ...
        public float popDuration = 0.05f; // faster pop for instant feedback

        [Header("Color")]
        [Tooltip("color for score feedback (green for positive)")]
        public Color scoreColor = new Color(0.3f, 1f, 0.3f); // bright green
        ...
        private void Awake()
        {
            ...
            // force center alignment so it spawns at correct position
            if (textMesh != null)
            {
        ...
        /// <summary>
        /// initialize and start the score number animation.
        /// </summary>
        ...
        private IEnumerator AnimateNumber()
        {
            ...
            while (elapsed < floatDuration)
            {
                ...
                if (t > 0.5f)
                {
                    ...
                    textMesh.color = new Color(scoreColor.r, scoreColor.g, scoreColor.b, alpha);
                }
